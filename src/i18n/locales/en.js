...
const en = {
  translation: {
    ...
    prototype_name_label: "Prototype Name",
    prototype_name_placeholder: "Enter prototype name",
    prototype_name_hint: "This will be used as the folder name for your prototype.",
    prototype_tables_label: "Tables to Generate ({{count}})",
    prototype_table_name: "Table Name",
    prototype_fields: "Fields",
    prototype_fields_count: "{{count}} fields",
    prototype_primary_key: "Primary Key",
    prototype_no_pk: "No PK",
    prototype_enter_name: "Please enter a prototype name",
    prototype_no_tables: "No tables found in the diagram",
    prototype_no_tables_hint: "Please add tables to your diagram first.",
    prototype_what_generated: "What will be generated?",
    prototype_gen_item1: "A ZIP file containing a folder for each table",
    prototype_gen_item2: "Each folder contains: HTML, Python (Flask API), and JSON files",
    prototype_gen_item3: "Double-click the HTML file to use the CRUD interface",
    prototype_gen_item4: "Run the Python file to start the API server",
    prototype_gen_item5: "Data is persisted in the JSON file",
    prototype_download_note: "Note: The file will be downloaded to your browser's default download location. You can move it to any folder after downloading.",
    prototype_generate: "Generate Prototype",
    prototype_generating: "Generating prototype...",
    prototype_progress: "Progress",
