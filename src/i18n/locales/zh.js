...
const zh = {
  translation: {
    ...
    prototype_name_label: "原型名称",
    prototype_name_placeholder: "请输入原型名称",
    prototype_name_hint: "这将用作原型文件夹的名称。",
    prototype_tables_label: "要生成的表 ({{count}})",
    prototype_table_name: "表名",
    prototype_fields: "字段",
    prototype_fields_count: "{{count}} 个字段",
    prototype_primary_key: "主键",
    prototype_no_pk: "无主键",
    prototype_enter_name: "请输入原型名称",
    prototype_no_tables: "设计图中没有表",
    prototype_no_tables_hint: "请先向设计图中添加表。",
    prototype_what_generated: "将生成什么内容？",
    prototype_gen_item1: "每个表一个文件夹的 ZIP 文件",
    prototype_gen_item2: "每个文件夹包含：HTML、Python (Flask API) 和 JSON 文件",
    prototype_gen_item3: "双击 HTML 文件即可使用 CRUD 界面",
    prototype_gen_item4: "运行 Python 文件启动 API 服务",
    prototype_gen_item5: "数据持久化在 JSON 文件中",
    prototype_download_note: "注意：文件将下载到浏览器的默认下载位置。您可以在下载后将其移动到任何文件夹。",
    prototype_generate: "生成原型",
    prototype_generating: "正在生成原型...",
    prototype_progress: "进度",
